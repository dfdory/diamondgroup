 ...
 <form class="form-horizontal"  method="post" action="envoi_contact.php">
  ...
  <fieldset >
   ...
   <div class="form-group" style="margin-bottom:20px;border-radius:15px;">
      ...
      <div class="col-md-8">
        <input type="text" name="nom" class="form-control input-sm" id=""  placeholder="Your Company Name ( * ) ">
	...
	<div class="form-group" style="margin-bottom:20px;border-radius:15px;">
      ...
      <div class="col-md-8">
        <input type="text" name="phone" class="form-control input-sm" id=""  placeholder="Your phone number ( * ) ">
     ...
     <div class="form-group" style="margin-bottom:20px;border-radius:15px;">
      ...
      <div class="col-md-8">
        <input type="email" name="email" class="form-control input-sm" id=""  placeholder="Your e-mail ( * )">
    ...
    <div class="form-group" style="margin-bottom:20px;border-radius:15px;">
      ...
      <div class="col-md-8">
        <input type="text" name="objet" class="form-control input-sm" id=""  placeholder="Object">
    ...
    <div class="form-group" >
	 ...
	 <button type="" class="col-md-2 btn btn-primary btn-sm " id="btn-news" style="width:90px;border-radius:0px 0px 0px 0px">Clear</button>
        <button type="submit" class="col-md-2 btn btn-primary btn-sm " id="btn-news" style="width:90px;border-radius:0px 0px 0px 0px;margin-left:25px">Submit</button>
      </div>
    </div>
		    ...
		    <div class="col-md-4" style="margin-top:30px">
                             ...
                             <h5 class="txt"><strong>Contact Informations</strong></h5>
	...
	<div class="col-md-8" style="margin-top:25px">
  	    <h5 class="txt"><strong>Location</strong></h5>
