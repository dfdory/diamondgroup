    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-mobile pull">
            <ul  class="nav navbar-nav" style="margin-top:5px;">
				...
				<li  class="active text-center outzone" style=""><a href="index.php">Accueil</a></li>
				<?php }else{ ?>
                                <li><a class="text-center outzone" href="index.php"  >Accueil </span></a></li>
				<?php }
					if($url=='project.php'){?>
						<li class="active text-center outzone"><a class=""  href="project.php">Projet</a></li>
                                   <?php } else{?>
                                   	<li class="text-center outzone"><a class=""  href="project.php">Projet</a></li>
				<?php }
					if($url=='about.php'){?>
						<li class="active text-center outzone"><a class=""  href="rental.php">Locations</a></li>
                                   <?php } else{?>
                                   	<li class="text-center outzone"><a class=""  href="rental.php">Locations</a></li>
				<?php }
					if($url=='rental.php'){?>
						<li class="active text-center outzone"><a class=""  href="about.php">A propos</a></li>
                                   <?php } else{?>
                                   	<li class="text-center outzone"><a class=""  href="about.php">A propos</a></li>
				<?php }
					if($url=='contact.php'){?>
	...
	<nav class="submenu text-center visible-lg theMenu " >
		<div class="submenu-wrap">		
			<i class="icon-remove menu-close " id="iesub"></i>	
				...
				<?php }
					if($url=='project.php'){?>
						<li class="active text-center"><a class=""  href="project.php">Projet</a></li>
                                   <?php } else{?>
                                   	<li class="text-center outzone"><a class=""  href="project.php">Projet</a></li>
				<?php }
					if($url=='about.php'){?>
