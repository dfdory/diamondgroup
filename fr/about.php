				...
				<div id="about-msg">
					<div class="text-center banners" id="banners" >
                                		 ...
                                		 <div class="text-center"  style="margin-top:25%">
                                    			<strong class="cap-txt text-center" style="">Diff&eacute;rentes approches,</strong>
							<strong class="cap-txt text-center">Diff&eacute;rentes M&eacute;thodes </strong> 
                                    			<span class="low-txt text-center" style=""> = R&eacute;sultats diff&eacute;rents <span class="low-txt" style="color:#fff;opacity:0;filter: alpha(opacity=0);">Bigger isn't always better.You deserve a personalized approach & we deliver.</span> </span> 
                                		</div>
                                		<div class="text-center"  style="margin-top:25%">
                                    			<strong class="cap-txt">Besoin d'attention?</strong>
                                                         <strong class="low-txt"><span class="low-txt" style="color:#fff;opacity:0;filter: alpha(opacity=0);">Nous sommes l&agrave; pour vous fournir une approche personnalis&eacute;e.</span></strong>
                                    			<span class="low-txt" style="font-size:98%;margin-top:-15px">Nous sommes l&agrave; pour vous fournir une approche personnalis&eacute;e.</span>
                                		</div>
                                		<div class="text-center"  style="margin-top:25%">
                                    			<strong class="cap-txt">Le statu quo?</strong>
							 <strong class="low-txt" style="font-size:100%"><span class="low-txt" style="color:#fff;opacity:0;filter: alpha(opacity=0);">The 'safe' choice rarely yields the results.the results.</span></strong>
                                    			<span class="low-txt text-center" style="font-size:95%;margin-top:-35px">Et si nous le remettions en cause?</span>
                                		</div>
				...
				<div id="about-msg" >
					<div class="text-center" id="banner" >
							...
							<strong class="cap-txt text-center">Diff&eacute;rentes M&eacute;thodes </strong> 
                                		...
                                		<div class="text-center"  style="margin-top:25%">
                                    			<strong class="cap-txt">Besoin d'attention?</strong>
                                    			<span class="low-txt">Nous sommes l&agrave; pour vous fournir une approche personnalis&eacute;e.</span>
                                		</div>
                                		<div class="text-center"  style="margin-top:25%">
                                    			<strong class="cap-txt1">Le Status Quo?</strong>
                                    			<span class="low1">Et si nous le remettions en cause?</span>
                                		</div>
				...
				<div id="about-msg" class="ox" style="" >
					<div class="text-center" id="banner0" >
                                		 <div class="text-center lt" style="margin-top:110px;" >
                                    			<strong class="cap-txt text-center" style="font-size:120%">Diff&eacute;rentes approches,</strong>
							<strong class="cap-txt text-center" style="font-size:120%">Diff&eacute;rentes M&eacute;thodes  </strong> 
                                    			<span class="low-txt text-center" style="font-size:95%">= R&eacute;sultats diff&eacute;rents  <span class="low-txt" style="color:#fff;opacity:0;filter: alpha(opacity=0);">Bigger isn't always better.You deserve a personalized approach & we deliver.</span> </span> 
                                		</div>
                                		<div class="text-center lt "  style="margin-top:110px;" >
                                    			<strong class="cap-txt text-center" style="font-size:120%">Besoin d'attention?</strong>
                                    			<span class="low-txt text-center" style="font-size:95%;">Nous sommes l&agrave; pour vous fournir une approche personnalis&eacute;e.</span>
                                		</div>
                                		<div class="text-center lt" style="margin-top:110px;">
                                    			<strong class="cap-txt text-center" style="font-size:120%">Le Status Quo?</strong>
                                    			<span class="low-txt text-center" style="font-size:95%;padding-left:40px">Et si nous le remettions en cause?</span>
                                		</div>
				...
				<div class="inner">
					<div class="kwiks_wrap">
						<ul class="kwicks vertical">
							...
							<li id="page_1_fr" style="margin-top:20px">
								<div class="text"></div>
								<div class="cont text-justify">
									<p class="pad_top1" style="font-size:95%;margin-top:10px;padding-right:20px">
										 
									Les leaderleaderleaders sont ambitieux, tenaces et ne se contentent jamais d'une r&eacute;ponse n&eacute;gative.                
									</p>
									
									<strong class="instig text-center" style="margin-top:25px" >L'equipe dirigeante <i class="fa fa-hand-o-right fa-2x" style="color: #3f4c6b;margin-left:5px"> </i> </strong>
								</div>
...
<li>Thirteen (13) years experience in world class IT and Telecom services design, project management and operations</li>
 ...
 <img src="../img/team/leit.png" height="200" width="50" id="leadership" alt="Leadership" class="img-responsivex alignleft imageborder size-full img-responsivex leitx">
                        ...
                        <p class="no-img text-justify" style="font-size:11px;color:#000405;padding-top:20px">	 
									Les leaders sont ambitieux, tenaces et ne se contentent jamais d&acute;une r&eacute;ponse n&eacute;gative.   
			</p>
 
                       
		</div>
       
			 <strong class="instig text-center" style="margin-top:25px" >L'equipe dirigeante  </strong>
		<div class="col-xs-12">
 
                        <h6 class="section-lex" style="margin-top:30px"> <strong> Roselyne MPOUDI NGOLE </strong></h6>	

			  <img src="../img/team/dir.png" height="200" width="50" id="managing" alt="Directrice G&eacute;n&eacute;rale" class="img-responsivex alignleft imageborder size-full img-responsivex leitx">
...
<li class="no-img text-justify" style="font-size:11px;color:#000405;padding-top:-1px">- Eight (8) years experience in project management,process design & optimization,operations and electronic banking with Tier-1 international banks</li>
		...
		<div class="col-xs-12">
			  ...
			  <img src="../img/team/pca.png" height="200" width="50" id="chairman" alt="Chairman" class="img-responsivex alignleft imageborder size-full img-responsivex leitx ">
