  ...
  <div class="carousel-inner" style="border:1px solid #000405;">
    <div class="item active" style="max-height: 670px;">
      ...
      <div class="carousel-caption2 visible-lg visible-md visible-sm  visible-xs">
       <strong >Bureaux &eacute;quip&eacute;s<br>
&agrave; partir de  9500 FCFA <br>par  m&sup2;par mois</strong>                    
      </div>
    </div>
   <div class="item " style="max-height: 670px;">
       ...
       <strong>Single tenant occupancy</strong>                    
      </div>
...
&agrave; partir de  9500 FCFA <br>par  m&sup2; par mois</strong>                    
    ...
    <div class="item" style="max-height: 670px;">
      <img  src="../img/gallery/Outside_05.jpg" alt="FRONT VIEW" width=100%>
      <div class="carousel-caption2 visible-lg visible-md visible-sm  visible-xs">
       <strong >Call (237) 680 99 00 55 & Start Today!!<br>
</strong>                    
      </div>
    </div>
                         ...
                         <div class="col-md-12 col-xs-12" style="margin-top:55px;border: 1px solid #a9a9a9;" >	
                            ...
                            <div class="text-center banners" style="">
                                ...
                                <div class="text-center"  style="">
                                    			<strong class="cap-txt2 text-center" style=" color:#3f4c6b">Etes-vous d&eacute;cid&eacute; ?</strong>
							
                                		</div>
                                <div class="text-center"  style="margin-top:12%">
                                    			<a href="contact.php" class="btn btn-primary" style=" font-style:normal;margin-top:40px;background-color:#3f4c6b;border-color:#3f4c6b">RESERVER</a>
